...
Public Class AddSoftwares
    ...
    Private Sub AddSoftwares_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Function addpro()
        ...
        If File.Exists(Application.StartupPath & "\procche\" & txtProc.Text & ".txt") = False Then
            File.Create(Application.StartupPath & "\procche\" & txtProc.Text & ".txt")
    ...
    Public Function DelSelPro()
        If Directory.Exists(Application.StartupPath & "\procche") = True Then
            For Each fls In Directory.GetFiles(Application.StartupPath & "\procche")
                'MsgBox(fls)
