    ...
    Public Shared Function Delete()
        ...
        Try
            ...
            Else
                chked = 0
            End If
            If main.ProcessRunning("firefox") = 1 And chked = 1 Then
                Dim ret = MsgBox("Firefox files cannot be deleted because firefox is running" & vbNewLine & "Do you want me to close Firefox for you ? ", MsgBoxStyle.Exclamation + vbYesNo, "Information")
                If ret = vbYes Then
                ...
                Else
                    '  lblScanStatus.Text = "Status : Skipping Firefox Items..."
                End If
            Else
                If Functiod.Cache.GetFirefoxCache <> "" Then
                    If chkedffcach = "true" Then
        ...
        Try
            If main.ProcessRunning("thunderbird") = 1 And chkedThun = "true" Then
                Dim ret = MsgBox("Thunderbird Files Cannot be deleted while it is Running" & vbNewLine & "Do you want me to close thunderbird for you ? ", MsgBoxStyle.Exclamation + vbYesNo, "Information")
                If ret = vbYes Then
                    ...
                    End If
                Else
                    'lblScanStatus.Text = "Status : Skipping Thunderbird Items..."
                End If
            Else
        ...
        Try
            ...
            If main.ProcessRunning("opera") = 1 And chked = 1 Then
                Dim ret = MsgBox("Opera files cannot be deleted because opera is running" & vbNewLine & "Do you want me to close opera for you ?", MsgBoxStyle.Exclamation + vbYesNo, "Information")
                If ret = vbYes Then
                    ...
                    End If
                Else
                    'lblScanStatus.Text = "Status : Skipping Opera items..."
                End If
            Else
                If Functiod.Cache.GetOperaCache <> "" Then
                    If chkedopercach = "true" Then
